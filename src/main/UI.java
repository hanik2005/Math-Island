...
//    g2d.drawImage(background_image, 0, 0, gp.screenW, gp.screenH, null);
...
// Helper method to draw wrapped text
  ...
  int yy = gp.tileSize * 3;
    ...
    g2d.setColor(Color.gray);
    g2d.drawString(textTitle, xxx += gp.tileSize * .5, yyy += gp.tileSize * 0.5);

     g2d.drawImage(gp.player.down1, xx += gp.tileSize * .3, y, gp.tileSize * 2, gp.tileSize * 2, null);
    ...
    g2d.drawString(text, x, y);
    if (commandNum == 0) {
        g2d.drawString("^", x += gp.tileSize * 0, y + gp.tileSize *1);
    }
    
   g2d.drawImage(gp.Gplayer.down1, xx += gp.tileSize * 5.5, yy, gp.tileSize * 2, gp.tileSize * 2, null);
    text = "Female";
    x += gp.tileSize * 5.0;
    y += gp.tileSize * 0;
    g2d.drawString(text, x, y);
    if (commandNum == 1) {
        g2d.drawString("^", x += gp.tileSize * 1.2, y + gp.tileSize *1);
    }
