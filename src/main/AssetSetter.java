...
public class AssetSetter {
    ...
    public void setObject (){
        ...
        gp.obj[mapNum][4] = new OBJ_FinalPortal(gp);
        gp.obj[mapNum][4].worldX = 20 * gp.tileSize;
        gp.obj[mapNum][4].worldY = 38 * gp.tileSize;
        ...
        gp.obj[mapNum][11] = new OBJ_Stone(gp);
        gp.obj[mapNum][11].worldX = 26 * gp.tileSize;
        gp.obj[mapNum][11].worldY = 7 * gp.tileSize;

        gp.obj[mapNum][12] = new OBJ_Orb(gp);
        gp.obj[mapNum][12].worldX = 42 * gp.tileSize;
        gp.obj[mapNum][12].worldY = 8 * gp.tileSize;
        
        gp.obj[mapNum][13] = new OBJ_DisplayManaCrystal(gp);
        gp.obj[mapNum][13].worldX = 31 * gp.tileSize;
        gp.obj[mapNum][13].worldY = 38 * gp.tileSize;
        
        gp.obj[mapNum][14] = new OBJ_DisplayManaCrystal(gp);
        gp.obj[mapNum][14].worldX = 14 * gp.tileSize;
        gp.obj[mapNum][14].worldY = 25 * gp.tileSize;
        
        gp.obj[mapNum][15] = new OBJ_DisplayManaCrystal(gp);
        gp.obj[mapNum][15].worldX = 30 * gp.tileSize;
        gp.obj[mapNum][15].worldY = 24 * gp.tileSize;
        
        gp.obj[mapNum][16] = new OBJ_DisplayManaCrystal(gp);
        gp.obj[mapNum][16].worldX = 37 * gp.tileSize;
        gp.obj[mapNum][16].worldY = 16 * gp.tileSize;
        
        gp.obj[mapNum][17] = new OBJ_DisplayManaCrystal(gp);
        gp.obj[mapNum][17].worldX = 21 * gp.tileSize;
        gp.obj[mapNum][17].worldY = 16 * gp.tileSize;
        
        gp.obj[mapNum][18] = new OBJ_DisplayManaCrystal(gp);
        gp.obj[mapNum][18].worldX = 21 * gp.tileSize;
        gp.obj[mapNum][18].worldY = 8 * gp.tileSize;
        
        gp.obj[mapNum][19] = new OBJ_DisplayManaCrystal(gp);
        gp.obj[mapNum][19].worldX = 41 * gp.tileSize;
    ...
    public void setStoneObject(){
        ...
        gp.obj[mapNum][0].worldY = 39 * gp.tileSize;
        
        gp.obj[mapNum][1] = new OBJ_Stone(gp);
        gp.obj[mapNum][1].worldX = 36 * gp.tileSize;
        gp.obj[mapNum][1].worldY = 35 * gp.tileSize;
        
        gp.obj[mapNum][2] = new OBJ_Stone(gp);
        gp.obj[mapNum][2].worldX = 24 * gp.tileSize;
        gp.obj[mapNum][2].worldY = 13 * gp.tileSize;
        
        gp.obj[mapNum][3] = new OBJ_Stone(gp);
        gp.obj[mapNum][3].worldX = 14 * gp.tileSize;
        ...
        gp.obj[mapNum][1].worldY = 31 * gp.tileSize;

        gp.obj[mapNum][2] = new OBJ_Stone(gp);
        gp.obj[mapNum][2].worldX = 15 * gp.tileSize;
        gp.obj[mapNum][2].worldY = 33 * gp.tileSize;
        ...
        gp.obj[mapNum][4] = new OBJ_Stone(gp);
        gp.obj[mapNum][4].worldX = 20 * gp.tileSize;
        gp.obj[mapNum][4].worldY = 24 * gp.tileSize;

        gp.obj[mapNum][5] = new OBJ_Stone(gp);
        gp.obj[mapNum][5].worldX = 37 * gp.tileSize;
        ...
        gp.obj[mapNum][9] = new OBJ_Stone(gp);
        gp.obj[mapNum][9].worldX = 21 * gp.tileSize;
        gp.obj[mapNum][9].worldY = 13 * gp.tileSize;

        gp.obj[mapNum][10] = new OBJ_Stone(gp);
        gp.obj[mapNum][10].worldX = 26 * gp.tileSize;
        gp.obj[mapNum][10].worldY = 7 * gp.tileSize;

        gp.obj[mapNum][11] = new OBJ_Stone(gp);
        gp.obj[mapNum][11].worldX = 35 * gp.tileSize;
        gp.obj[mapNum][11].worldY = 7 * gp.tileSize;
...
//        gp.obj[mapNum][12].worldY = 8 * gp.tileSize;
     ...
     public void makeAllStonesDisappearAcrossAllMaps() {
    for (int mapNum = 0; mapNum < gp.obj.length; mapNum++) {
        for (int i = 0; i < gp.obj[mapNum].length; i++) {
            if (gp.obj[mapNum][i] instanceof OBJ_Stone) {
